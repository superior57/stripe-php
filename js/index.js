...
// var stripe = Stripe('pk_test_51HhycsD5pdCP2ysKWUMmtzhh7zNE8vbANOsOY1mlTVFHO6TVoM96LCHbC9aBhertTc219gqSrHb2rICKwy97Txsw00wB5uvUk3');
var stripe = Stripe('pk_live_51HMyCCH36l8zLweIIeO4F3sU4rQopEYuKEz1bRtkZSxhT0FD0RjenxuIhogySQdMUTDsEnpOPCBoVq02RbnxjflE00hRoFhY8P');
...
function registerElements(elements, exampleName) {
  ...
  form.addEventListener('submit', function(e) {
    ...
    var currency = form.querySelector('#currency').value;
    var additionalData = {
    ...
    stripe.createToken(elements[0], additionalData).then(function(result) {
      ...
      if (result.token) {
        ...
        $.post("process.php", {token: result.token.id, price: getPriceFormat(document.getElementsByName('amount')[0].value), phone:phonenumber,name:Cusname, currency }, function(result){
